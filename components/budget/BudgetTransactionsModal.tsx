...
import { Calendar, Repeat, TrendingUp, DollarSign, BarChart3, Target, AlertTriangle, CheckCircle } from 'lucide-react';
        ...
        <DialogHeader className="space-y-3 pb-4">
          ...
          <div className="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-400 flex-wrap">
            ...
            <Badge 
              ...
              className="text-xs"
            >
              {formatCurrency(currentSpent)} / {formatCurrency(budgetLimit)}
            </Badge>
          </div>
        </DialogHeader>
          ...
          <div className="p-4 rounded-lg border bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700">
            ...
            <div className="grid grid-cols-3 gap-6 text-sm">
              <div className="text-center">
                <div className="text-slate-600 dark:text-slate-400 text-xs font-medium mb-1">Budget Limit</div>
                <div className="font-semibold text-slate-900 dark:text-slate-100 text-base">
                  {formatCurrency(budgetLimit)}
                </div>
              </div>
              <div className="text-center">
                <div className="text-slate-600 dark:text-slate-400 text-xs font-medium mb-1">Current Spent</div>
                <div className={`font-semibold text-base ${
                  isOverBudget ? 'text-red-600 dark:text-red-400' : 'text-slate-900 dark:text-slate-100'
                }`}>
            ...
            <>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="font-semibold text-base text-slate-800 dark:text-slate-200">Budget Analysis</h3>
                </div>
                  ...
                  <div className={`rounded-lg p-3 border ${
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className={`text-xs font-medium ${
                        isOverBudget ? 'text-red-900 dark:text-red-100' : 'text-blue-900 dark:text-blue-100'
                      }`}>
                        Total Spent
                      </span>
                    </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-800/30 rounded-lg p-4 border border-slate-200 dark:border-slate-700">
                  <h4 className="font-medium text-sm text-slate-700 dark:text-slate-300 mb-3">Budget Insights</h4>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        {isOverBudget 
                          ...
                          : `Within budget (${formatCurrency(remainingBudget)} remaining)`
                        }
                      </span>
                    </div>
