...
// Type compatibility fixes for recharts
...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentProps<'div'> & {
    ...
    label?: React.ReactNode;
    labelFormatter?: (value: any, payload: RechartsPayload[]) => React.ReactNode;
    formatter?: (value: any, name: string, item: RechartsPayload, index: number, payload: any) => React.ReactNode;
    color?: string;
    hideLabel?: boolean;
